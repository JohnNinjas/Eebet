...
<div class="row">
    <div class="col-xs-6">
        <div class="panel panel-info">
            ...
            <div class="panel-footer">
                <a class="btn btn-success" href="<?= Url::toRoute(['/rbac/create', 'type' => Item::TYPE_ROLE])?>" role="button"><?= Yii::t('users', 'CREATE')?></a>
            </div>
        </div>
    </div>
    ...
    <div class="col-xs-6">
        <div class="panel panel-info">
            ...
            <div class="panel-footer">
                <a class="btn btn-success" href="<?= Url::toRoute(['/rbac/create'])?>" role="button"><?= Yii::t('users', 'CREATE')?></a>
            </div>
        </div>
    </div>
    ...
    <div class="col-xs-12">
        <div class="panel panel-info">
            ...
            <div class="panel-footer">
                <a class="btn btn-success" href="<?= Url::toRoute(['/rbac/create', 'type' => Item::TYPE_PERMISSION])?>" role="button"><?= Yii::t('users', 'CREATE')?></a>
            </div>
        </div>
    </div>
</div>